...
const whitelist = [
  ...
  `Don't let that dopey smile deceive you... Churro's a master ROYAL chef!`,
  `Nommm... Oh hi, I'm just meditating on the meaning of ROYAL.`,
  `Three guesses what's put that twinkle in those eyes! (Hint: it's ROYAL)`,
