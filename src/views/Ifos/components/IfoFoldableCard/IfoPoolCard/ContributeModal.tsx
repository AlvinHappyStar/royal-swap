...
const ContributeModal: React.FC<React.PropsWithChildren<Props>> = ({
  ...
  const label = currency === bscTokens.cake ? t('Max. ROYAL entry') : t('Max. token entry')
  ...
  const unlimitedToolipContent = (
    <Box>
      ...
      <Text display="inline">
        {t('Lock more ROYAL for longer durations to increase the maximum number of ROYAL you can commit to the sale.')}
      </Text>
    </Box>
  )
      ...
      <ModalBody maxWidth="360px">
        <Box p="2px">
          ...
          <Text color="textSubtle" fontSize="12px" mb="24px">
            {t(
              'If you don’t commit enough ROYAL, you may not receive a meaningful amount of IFO tokens, or you may not receive any IFO tokens at all.',
            )}
            <Link
              fontSize="12px"
              display="inline"
