...
const LockedStakingApy: React.FC<React.PropsWithChildren<LockedStakingApyProps>> = ({
  ...
  const earningTokenBalance = useMemo(() => {
    return getBalanceNumber(currentLockedAmountAsBigNumber.minus(userData?.royalAtLastUserAction))
  }, [currentLockedAmountAsBigNumber, userData?.royalAtLastUserAction])
