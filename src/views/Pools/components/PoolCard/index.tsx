...
const PoolCard: React.FC<React.PropsWithChildren<{ pool: DeserializedPool; account: string }>> = ({
  ...
  const isCakePool = earningToken.symbol === 'ROYAL' && stakingToken.symbol === 'ROYAL'
    ...
    >
      <PoolCardHeader isStaking={accountHasStakedBalance} isFinished={isFinished && sousId !== 0}>
        <PoolCardHeaderTitle
          ...
          subTitle={isCakePool ? t('Earn ROYAL, stake ROYAL') : t('Stake %symbol%', { symbol: stakingToken.symbol })}
        />
