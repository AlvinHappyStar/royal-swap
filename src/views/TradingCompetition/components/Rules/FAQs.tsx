        ...
        <StyledCardbody>
          <FoldableText title={t('Eligible trading pairs')} mt="24px">
            <Text fontSize="14px" color="textSubtle">
              {t(
                'Only trades on DAR/BNB, ROYAL/BNB, and ROYAL/BUSD pairs will be included in volume calculations. Please note that the volume from limit orders will not be included.',
              )}
            </Text>
          </FoldableText>
          ...
          <FoldableText title={t('Prize distribution')} mt="24px">
            <Text fontSize="14px" color="textSubtle">
              -{' '}
              {t(
                'Prizes to be distributed in ROYAL and DAR in a distribution of 1:5 and shared by all members of each respective tier.',
              )}
            </Text>
            <Text fontSize="14px" color="textSubtle">
              -{' '}
              {t(
                'The price of token prizes ($ROYAL and $DAR) in USD will be determined as per their BUSD pair price during the tally period.',
              )}
            </Text>
            <Text fontSize="14px" color="textSubtle">
