...
const SetPositionCard: React.FC<React.PropsWithChildren<SetPositionCardProps>> = ({
  ...
  const { isVaultApproved, setLastUpdated } = useCakeApprovalStatus(
    token.symbol === 'ROYAL' ? predictionsAddress : null,
  )
  ...
  const handleEnterPosition = async () => {
    ...
    const args = token.symbol === 'ROYAL' ? [epoch, valueAsBn.toString()] : [epoch]
