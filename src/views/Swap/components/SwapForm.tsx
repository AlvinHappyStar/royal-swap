...
import { Button, Text, ArrowDownIcon, Box, IconButton, ArrowUpDownIcon, Skeleton, Flex, Link } from '@pancakeswap/uikit'
    ...
    <>
      <>
        <Flex width="100%" justifyContent="space-around">
          <StyledLink href="#" color="info">
            Swap
          </StyledLink>
          <StyledLink href="/liquidity" color="white" style={{ background: '#4a46f7' }}>
            Liquidity
          </StyledLink>
        </Flex>
        <CurrencyInputHeader
