...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and ROYAL pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and ROYAL pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from ROYAL pool', data)
  }
