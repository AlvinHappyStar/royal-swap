...
export const transformBetResponse = (tokenSymbol) =>
  tokenSymbol === 'ROYAL' ? transformBetResponseCAKE : transformBetResponseBNB

export const transformUserResponse = (tokenSymbol) =>
  tokenSymbol === 'ROYAL' ? transformUserResponseCAKE : transformUserResponseBNB
...
export const getTotalWon = async (): Promise<{ totalWonBNB: number; totalWonCAKE: number }> => {
  ...
  const totalWonCAKE = getTotalWonMarket(CAKEMarket, 'ROYAL')
