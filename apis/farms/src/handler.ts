...
import { BUSD, ROYAL } from '@pancakeswap/tokens'
...
const cakeBusdPairMap = {
  [ChainId.BSC]: {
    address: Pair.getAddress(ROYAL[ChainId.BSC], BUSD[ChainId.BSC]),
    tokenA: ROYAL[ChainId.BSC],
    tokenB: BUSD[ChainId.BSC],
  },
  [ChainId.BSC_TESTNET]: {
    address: Pair.getAddress(ROYAL[ChainId.BSC_TESTNET], BUSD[ChainId.BSC_TESTNET]),
    tokenA: ROYAL[ChainId.BSC_TESTNET],
